...
```{r}
cleanDF$Category <- factor(cleanDF$Category, levels = c("0=Blood Donor", "1=Hepatitis"), labels = c("Blood Donor", "Hepatitis")) %>% relevel("Blood Donor")
head(cleanDF, 10)
```
...
```
##Accuracy of 68% is too low
##I could have used more characteristics
