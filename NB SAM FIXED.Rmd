...
```{r} 
rawdata <- mutate(rawdata,label = recode(label,"1" = "Fake News","0" = "Real News")) 
``` 
...
##I would have tried to find a way to use the whole dataset if possible, if it was impossible then I also would have deleted a few rows in order to process the data